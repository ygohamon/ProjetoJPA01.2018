...
public class TableModelVenda extends AbstractTableModel{
	...
	public TableModelVenda(List<Venda> vendas) {
		...
		this.venda = new ArrayList<Venda>(vendas);
	}
    ...
    public String getColumnName(int columnIndex) {
        ...
        String colunas[] = {"Id", "Numero","Cliente","Produto"};
    ...
    public Object getValueAt(int row, int column) {
        ...
        else if (column == 1) return vendas.getNumero();
        else if (column == 2) return vendas.getCliente();
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
    	...
    	else if (columnIndex == 1) est.setNumero((String)aValue);
        else if (columnIndex == 2) est.setCliente((String)aValue);
        else if (columnIndex == 3) est.setProduto((String)aValue);
