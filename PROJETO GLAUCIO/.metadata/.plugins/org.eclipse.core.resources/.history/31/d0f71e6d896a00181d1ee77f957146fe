...
public class TableModelVenda extends AbstractTableModel{
	...
	public TableModelVenda(List<Venda> vendas) {
		...
		this.venda = new ArrayList<Produto>(venda);
	}
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
    	...
    	Produto est = venda.get(rowIndex);
 ...
 // Retorna o Estado referente a linha especificada
    ...
    public void addVenda(Produto vendas) {
        // Adiciona o registro.
    	venda.add(vendas);
    ...
    public void addListaDeVenda(List<Produto> vendaMethod) {
